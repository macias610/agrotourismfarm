namespace Repository.Migrations
{
    ...
    public partial class changed_delete_on_cascade_relations : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey("dbo.Reservation_Houses", "ReservationId", "dbo.Reservation", "Id", cascadeDelete: true);
            AddForeignKey("dbo.Reservation_Houses", "MealId", "dbo.Meal", "Id");
        ...
        public override void Down()
        {
            ...
            AddForeignKey("dbo.Reservation_House_Participant", "Reservation_HouseId", "dbo.Reservation_Houses", "Id");
            AddForeignKey("dbo.Reservation_Houses", "MealId", "dbo.Meal", "Id", cascadeDelete: true);
            AddForeignKey("dbo.Reservation_Houses", "ReservationId", "dbo.Reservation", "Id");
