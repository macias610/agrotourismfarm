namespace Repository.Migrations
{
    ...
    public partial class removed_table_ReservationHouseParticipant_changed_delete_on_cascade : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey("dbo.Participant", "Reservation_HouseId", "dbo.Reservation_House", "Id", cascadeDelete: true);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Participant", "Reservation_HouseId", "dbo.Reservation_House");
